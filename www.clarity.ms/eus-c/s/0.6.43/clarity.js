/* clarity-js v0.6.43: https://github.com/microsoft/clarity (License: MIT) */ ! function() {
    "use strict";
    var t = Object.freeze({
            __proto__: null,
            get start() {
    ...
    function O(t, e) {
        Fr() && t && e && "string" == typeof t && "string" == typeof e && t.length < 255 && e.length < 255 && (E = {
            key: t,
            value: e
        }, Ga(24))
    }
    ...
    function A() {
        ...
        x = {
            gap: t - C
        }, Ga(25), x.gap < 3e5 ? z = D(A, j) : Ur && (O("clarity", "suspend"), si(), ["mousemove", "touchstart"].forEach((function(t) {
    ...
    function U(t) {
        Fr() && u.lean && (u.lean = !1, P = {
            key: t
        }, mr(), u.upgrade && u.upgrade(t), Ga(3))
    }
    var B = Object.freeze({
            __proto__: null,
            get data() {
            ...
            default:
                ...
                if (u && u.length > 0)
                    if (0 === e) {
                        ...
                        c in bt || (bt[c] = []), bt[c].indexOf(t.id) < 0 && bt[c].push(t.id), i = "".concat(c).concat("~").concat(bt[c].indexOf(t.id))
                    } else i = "".concat(a).concat(t.tag, ".").concat(u).concat(r);
                return i = o && wt(o) ? "".concat(function(t) {
    ...
    function _t() {
        var t = Et.shift();
        t && (Ot = t, t.task().then((function() {
            t.id === pr() && (t.resolve(), Ot = null, _t())
        })).catch((function(e) {
            t.id === pr() && (e && ja(0, 1, e.name, e.message, e.stack), Ot = null, _t())
        })))
    }

    function Tt(t) {
        var e = jt(t);
        return e in kt ? performance.now() - kt[e].start > kt[e].yield ? 0 : 1 : 2
    }
    ...
    var Lt, At = window.requestIdleCallback || function(t, e) {
    ...
    function Rt(t, e, n) {
        return void 0 === e && (e = null), void 0 === n && (n = null), Q(this, void 0, void 0, (function() {
            var a, r, i, o, c, s, d, f, h, p, v, g, y, w, k, E, O, x, M, S, N, _;
            return $(this, (function(T) {
                switch (T.label) {
                    case 0:
                        ...
                        return [3, 10];
                    case 1:
                        return i = Lt, r.push(i.width), r.push(i.height), m(t, i.width, i.height), ka(r), [3, 10];
                    case 2:
                        for (o = 0, c = Bn; o < c.length; o++) s = c[o], (r = [s.time, 7]).push(s.data.id), r.push(s.data.interaction), r.push(s.data.visibility), r.push(s.data.name), ka(r);
                        return aa(), [3, 10];
                    case 3:
                        ...
                        f = 0, h = d, T.label = 4;
                    case 4:
                        return f < h.length ? (p = h[f], 0 !== (v = Tt(e)) ? [3, 6] : [4, Ct(e)]) : [3, 8];
                    case 5:
                        v = T.sent(), T.label = 6;
                    case 6:
                        if (2 === v) return [3, 8];
                        for (g = p.data, y = p.metadata.active, w = p.metadata.suspend, k = p.metadata.privacy, E = function(t) {
                            ...
                            }(p), O = 0, x = y ? ["tag", "attributes", "value"] : ["tag"]; O < x.length; O++)
                            if (g[M = x[O]]) switch (M) {
                                case "tag":
                                    S = Ht(p), N = E ? -1 : 1, r.push(p.id * N), p.parent && y && r.push(p.parent), p.previous && y && r.push(p.previous), r.push(w ? "*M" : g[M]), S && 2 === S.length && r.push("".concat("#").concat(Yt(S[0]), ".").concat(Yt(S[1])));
                                    break;
                                case "attributes":
                                    for (_ in g[M]) void 0 !== g[M][_] && r.push(Wt(_, g[M][_], k));
                                    break;
                                case "value":
                                    gt(p.metadata.fraud, p.id, g[M]), r.push(ft(g[M], g.tag, k, E))
                            }
                        T.label = 7;
                    case 7:
                        return f++, [3, 4];
                    case 8:
                        6 === t && b(a), ka(function(t) {
    ...
    function qt() {
        ...
        null !== Lt && c === Lt.width && v === Lt.height || null === c || null === v || (Lt = {
            width: c,
            height: v
        }, Rt(8))
    }
    ...
    function ae(t) {
        ...
        if (e && e.type && n) {
            ...
            ne.length > 0 && ne[ne.length - 1].data.target === r.target && ne.pop(), ne.push({
                time: l(),
                event: 27,
                data: r
            }), I(ee), ee = D(re, 500, 27)
    ...
    function le(t, e, n) {
        ...
        if (i)
            for (var u = 0; u < i.length; u++) {
                ...
                s = s && a ? s + Math.round(a.offsetLeft) : s, d = d && a ? d + Math.round(a.offsetTop) : d, null !== s && null !== d && de({
                    time: o,
                    event: t,
                    data: {
                        target: ra(n),
    ...
    function de(t) {
        switch (t.event) {
            ...
            case 19:
                ...
                }(n, t) && ue.pop(), ue.push(t), I(ce), ce = D(fe, 500, t.event);
                break;
            default:
    ...
    function be(t) {
        ...
        if ((null !== t || 0 !== i || 0 !== o) && null !== i && null !== o) {
            ...
            }(s, u) && ge.pop(), ge.push(u), I(me), me = D(ye, 500, 10)
        }
    }
    ...
    function Oe(t) {
        ...
        if (null !== e && !(null === e.anchorNode && null === e.focusNode || e.anchorNode === e.focusNode && e.anchorOffset === e.focusOffset)) {
            ...
            null !== ke && null !== we.start && n !== e.anchorNode && (I(Ee), xe(21)), we = {
                start: e.anchorNode,
                startOffset: e.anchorOffset,
                end: e.focusNode,
                endOffset: e.focusOffset
            }, ke = e, I(Ee), Ee = D(xe, 500, 21)
        }
    }
    ...
    function Le(t) {
        ...
        }(t), t.nodeType === Node.DOCUMENT_NODE && (Vt(t), function(t) {
            zr(t, "cut", $t.bind(this, 0), !0), zr(t, "copy", $t.bind(this, 1), !0), zr(t, "paste", $t.bind(this, 2), !0)
        }(t), function(t) {
            zr(t, "mousedown", se.bind(this, 13, t), !0), zr(t, "mouseup", se.bind(this, 14, t), !0), zr(t, "mousemove", se.bind(this, 12, t), !0), zr(t, "wheel", se.bind(this, 15, t), !0), zr(t, "dblclick", se.bind(this, 16, t), !0), zr(t, "touchstart", le.bind(this, 17, t), !0), zr(t, "touchend", le.bind(this, 18, t), !0), zr(t, "touchmove", le.bind(this, 19, t), !0), zr(t, "touchcancel", le.bind(this, 20, t), !0)
        }(t), function(t) {
            zr(t, "input", ae, !0)
        }(t), function(t) {
            zr(t, "selectstart", Oe.bind(this, t), !0), zr(t, "selectionchange", Oe.bind(this, t), !0)
        }(t), function(t) {
            zr(t, "submit", Te, !0)
        }(t))
    }
    var Ae = Object.freeze({
            __proto__: null,
            start: function() {
                ua = [], sa(), Kt(), te(), he(), ie(), zr(window, "resize", pe), pe(), zr(document, "visibilitychange", je), je(), ge = [], be(), Me(), De(), zr(window, "pagehide", Ie)
            },
            stop: function() {
                ua = [], sa(), Kt(), te(), I(ce), ue.length > 0 && fe(ue[ue.length - 1].event), I(ee), ie(), ve(), ze(), I(me), ge = [], Me(), I(Ee), De(), Ce()
            },
            observe: Le
        }),
        Re = /[^0-9\.]/g;
        ...
        for (var e = 0, n = Object.keys(t); e < n.length; e++) {
            ...
            if ("@type" === a && "string" == typeof r) switch (r = (r = r.toLowerCase()).indexOf("article") >= 0 || r.indexOf("posting") >= 0 ? "article" : r) {
                ...
                case "recipe":
                    ...
                    break;
                case "product":
                    ir(5, t[a]), ir(10, t.name), ir(12, t.sku), t.brand && ir(6, t.brand.name);
                    break;
                case "aggregaterating":
                    t.ratingValue && (T(11, Ye(t.ratingValue, 100)), T(18, Ye(t.bestRating)), T(19, Ye(t.worstRating))), T(12, Ye(t.ratingCount)), T(17, Ye(t.reviewCount));
                    break;
                case "person":
                    ir(8, t.name);
                    break;
                case "offer":
                    ir(7, t.availability), ir(14, t.itemCondition), ir(13, t.priceCurrency), ir(12, t.sku), T(13, Ye(t.price));
                    break;
                case "brand":
                    ir(6, t.name)
            }
    ...
    var We = ["title", "alt", "onload", "onfocus", "onerror", "data-drupal-form-submit-last"],
        Xe = /[\r\n]+/g;
    ...
    function qe(e, n) {
        ...
        switch (e.nodeType) {
            ...
            case Node.DOCUMENT_FRAGMENT_NODE:
                ...
                break;
            case Node.TEXT_NODE:
                if (i = i || e.parentNode, "update" === r || i && Xn(i) && "STYLE" !== i.tagName) {
                    var p = {
                        tag: "*T",
                        value: e.nodeValue
                    };
            ...
            case Node.ELEMENT_NODE:
                ...
                switch (i = e.parentElement ? e.parentElement : e.parentNode ? e.parentNode : null, "http://www.w3.org/2000/svg" === v.namespaceURI && (g = "svg:" + g), g) {
                    ...
                    case "IFRAME":
                        ...
                        In(O) && (! function(t) {
                            !1 === Xn(t) && zr(t, "load", cn.bind(this, t, "childList"), !0)
                        }(O), x.attributes["*O"] = "true", O.contentDocument && O.contentWindow && "loading" !== O.contentDocument.readyState && (a = O.contentDocument)), t[r](e, i, x, n);
                        break;
                    default:
                        var M = {
                            tag: g,
    ...
    function Be(t) {
        ...
        try {
            ...
            if (ja(1, 1, t ? t.name : null), t && "SecurityError" !== t.name) throw t
        }
        if (null !== n)
        ...
        return Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(s) {
                switch (s.label) {
                    ...
                    case 2:
                        return n < a.length ? (r = a[n], 0 !== (i = Tt(t)) ? [3, 4] : [4, Ct(t)]) : [3, 6];
                    case 3:
                        i = s.sent(), s.label = 4;
                    case 4:
                        if (2 === i) return [3, 6];
                        switch (o = r.target, u = function(t, e) {
                            var n = t.target ? Yn(t.target.parentNode) : null;
                            if (n && "HTML" !== n.data.tag) {
                                var a = l() > tn,
                                    r = Yn(t.target),
                                    i = r && r.selector ? r.selector.join() : t.target.nodeName,
                                    o = [n.selector ? n.selector.join() : "", i, t.attributeName, rn(t.addedNodes), rn(t.removedNodes)].join();
                                en[o] = o in en ? en[o] : [0];
                                var u = en[o];
                                if (!1 === a && u[0] >= 10 && on(u[1], 2, e), u[0] = a ? u[0] + 1 : 1, 10 === u[0]) return u[1] = t.removedNodes, "suspend";
                                if (u[0] > 10) return ""
                            }
                            return t.type
        ...
        return Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(o) {
                switch (o.label) {
                    ...
                    case 1:
                        return r < a ? 1 !== e ? [3, 2] : (Ve(t[r], n, e), [3, 5]) : [3, 6];
                    case 2:
    ...
    function un(t, e) {
        return void 0 === e && (e = !1), Qe.indexOf(t) < 0 && Qe.push(t), $e && I($e), $e = D((function() {
            ! function(t) {
    ...
    function Sn() {
        sn = 1, ln = [], dn = [], fn = [], hn = {}, pn = [], vn = [], mn = "address,password,contact".split(","), bn = "password,secret,pass,social,ssn,name,code,dob,cell,mob,contact,hidden,account,cvv,ccv,email,tel,phone,address,addr,card,zip".split(","), yn = "radio,checkbox,range,button,reset,submit".split(","), wn = new WeakMap, kn = new WeakMap, En = new WeakMap, On = new WeakMap, bt = {}
    }
    ...
    function Tn(t, e, n, a) {
        var r, i = _n(t, !0),
            ...
            h = u.content ? 1 : 3;
        o >= 0 && dn[o] && ((s = dn[o]).children.push(i), l = null === l ? s.region : l, d = s.fragment, f = null === f ? s.metadata.fraud : f, h = s.metadata.privacy), n.attributes && "data-clarity-region" in n.attributes && (Kn(t, n.attributes["data-clarity-region"]), l = i), ln[i] = t, dn[i] = {
                id: i,
                parent: o,
                previous: c,
                children: [],
            ...
            function(t, e, n) {
                ...
                switch (!0) {
                    ...
                    case "*T" === u:
                        ...
                        r.privacy = l.includes(c) || pn.some((function(t) {
                    ...
                    case "INPUT" === u && 0 === i:
                        ...
                        break;
                    case "INPUT" === u && 1 === i:
                        r.privacy = jn(o.class, mn, r), r.privacy = jn(o.type, bn, r), r.privacy = yn.indexOf(o.type) >= 0 ? 0 : r.privacy;
                        break;
                    case 1 === i:
                        r.privacy = jn(o.class, mn, r)
                }
            }(t, dn[i], s), Ln(dn[i]), "IMG" === (r = dn[i]).data.tag && 3 === r.metadata.privacy && (r.metadata.size = []), Un(i, a, dn[i].fragment)
    }
    ...
    function Dn(t, e, n, a) {
        ...
        if (r in dn) {
            ...
            s.fragment && gn[s.fragment] && (u = !0), Ln(s), Un(r, a, dn[r].fragment, u, c)
        }
    }
    ...
    function Ln(t) {
        ...
        t.selector = [yt(i, 0), yt(i, 1)], t.hash = t.selector.map((function(t) {
            return t ? f(t) : null
    ...
    function Un(t, e, n, a, r) {
        if (void 0 === n && (n = null), void 0 === a && (a = !0), void 0 === r && (r = !1), n && !gn[n]) {
            var i = Rn(n),
                o = Hn(n);
            i && o && (un(i, !0), o.hash.forEach((function(t) {
                -1 !== Ya.indexOf(t) && (gn[n] = t)
            })))
        }
        var u = fn.indexOf(t);
        u >= 0 && 1 === e && r ? (fn.splice(u, 1), fn.push(t)) : -1 === u && a && fn.push(t)
    }
    var Bn = [],
        Vn = null,
        Fn = {},
    ...
    function Kn(t, e) {
        !1 === Vn.has(t) && (Vn.set(t, e), (Zn = null === Zn && Gn ? new IntersectionObserver(ta, {
            threshold: [0, .2, .4, .6, .8, 1]
        }) : Zn) && t && t.nodeType === Node.ELEMENT_NODE && Zn.observe(t))
    }
    ...
    function $n() {
        for (var t = [], e = 0, n = Jn; e < n.length; e++) {
            var a = n[e],
                r = _n(a.node);
            r in Fn || (r ? (a.data.id = r, Fn[r] = a.data, Bn.push(na(a.data))) : t.push(a))
        }
    ...
    function ta(t) {
        for (var e = 0, n = t; e < n.length; e++) {
            ...
            if (Vn.has(r) && i.width + i.height > 0 && u.width > 0 && u.height > 0) {
                ...
                ea(r, s, s.interaction, d ? 13 : l ? 10 : 0), s.visibility >= 13 && Zn && Zn.unobserve(r)
            }
        }
        Bn.length > 0 && Rt(7)
    }
    ...
    function ea(t, e, n, a) {
        ...
        e.interaction = n > e.interaction ? n : e.interaction, e.visibility = a > e.visibility ? a : e.visibility, e.id ? (e.id in Fn && r || !(e.id in Fn)) && (Fn[e.id] = e, Bn.push(na(e))) : Jn.push({
            node: t,
            data: e
        })
    }
    ...
    function ra(t) {
        ...
        return tn = l() + 3e3, n.nodeType === Node.DOCUMENT_NODE ? n.documentElement : n
    }
    ...
    function oa(t) {
        return Q(this, void 0, void 0, (function() {
            var e, n, a, r, i, o, u, c, s, d, f, h, p, v, g, b, w, k, E, O, x, M, S, N, _, T, D, I, C;
            return $(this, (function(j) {
                switch (e = l(), n = [e, t], t) {
                    ...
                    case 19:
                    case 20:
                        for (a = 0, r = ue; a < r.length; a++) I = r[a], (i = ia(I.data.target, I.event)).id > 0 && ((n = [I.time, I.event]).push(i.id), n.push(I.data.x), n.push(I.data.y), ka(n), m(I.event, I.data.x, I.data.y));
                        he();
                        break;
                    case 9:
                        for (o = 0, u = Bt; o < u.length; o++) I = u[o], c = ia(I.data.target, I.event, I.data.text), n = [I.time, I.event], s = c.hash.join("."), n.push(c.id), n.push(I.data.x), n.push(I.data.y), n.push(I.data.eX), n.push(I.data.eY), n.push(I.data.button), n.push(I.data.reaction), n.push(I.data.context), n.push(ft(I.data.text, "click", c.privacy)), n.push(I.data.link), n.push(s), n.push(I.data.trust), ka(n), la(I.time, I.event, s, I.data.x, I.data.y, I.data.reaction, I.data.context);
                        Kt();
                        break;
                    case 38:
                        for (d = 0, f = Qt; d < f.length; d++) I = f[d], n = [I.time, I.event], (_ = ia(I.data.target, I.event)).id > 0 && (n.push(_.id), n.push(I.data.action), ka(n));
                        te();
                        break;
                    case 11:
                        h = oe, n.push(h.width), n.push(h.height), m(t, h.width, h.height), ve(), ka(n);
                        break;
                    case 26:
                        p = Se, n.push(p.name), Ce(), ka(n);
                        break;
                    case 27:
                        for (v = 0, g = ne; v < g.length; v++) I = g[v], b = ia(I.data.target, I.event, I.data.value), (n = [I.time, I.event]).push(b.id), n.push(ft(I.data.value, "input", b.privacy)), ka(n);
                        ie();
                        break;
                    case 21:
                        (w = we) && (k = ia(w.start, t), E = ia(w.end, t), n.push(k.id), n.push(w.startOffset), n.push(E.id), n.push(w.endOffset), Me(), ka(n));
                        break;
                    case 10:
                        for (O = 0, x = ge; O < x.length; O++) I = x[O], (M = ia(I.data.target, I.event)).id > 0 && ((n = [I.time, I.event]).push(M.id), n.push(I.data.x), n.push(I.data.y), ka(n), m(I.event, I.data.x, I.data.y));
                        ge = [];
                        break;
                    case 39:
                        for (S = 0, N = _e; S < N.length; S++) I = N[S], n = [I.time, I.event], (_ = ia(I.data.target, I.event)).id > 0 && (n.push(_.id), ka(n));
                        De();
                        break;
                    case 22:
                        for (T = 0, D = ca; T < D.length; T++) I = D[T], (n = [I.time, I.event]).push(I.data.type), n.push(I.data.hash), n.push(I.data.x), n.push(I.data.y), n.push(I.data.reaction), n.push(I.data.context), ka(n, !1);
                        sa();
                        break;
                    case 28:
    ...
    function la(t, e, n, a, r, i, o) {
        void 0 === i && (i = 1), void 0 === o && (o = 0), ua.push({
            time: t,
            event: 22,
            data: {
                type: e,
    ...
    var da, fa, ha, pa, va, ga = 0,
        ma = 0,
        ba = null,
        ya = 0;

    function wa() {
        pa = !0, ga = 0, ma = 0, ya = 0, da = [], fa = [], ha = {}, va = null
    }
    ...
    function ka(t, e) {
        if (void 0 === e && (e = !0), pa) {
            ...
            N(25);
            var i = function() {
                var t = !1 === u.lean && ga > 0 ? 100 : Sr.sequence * u.delay;
                return "string" == typeof u.upload ? Math.max(Math.min(t, 3e4), 100) : u.delay
            }();
            n - ya > 2 * i && (I(ba), ba = null), e && null === ba && (25 !== a && L(), ba = D(Oa, i), ya = n, Ka(ma))
        }
    }

    function Ea() {
        I(ba), Oa(!0), ga = 0, ma = 0, ya = 0, da = [], fa = [], ha = {}, va = null, pa = !1
    }
    ...
    function Oa(t) {
        return void 0 === t && (t = !1), Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(l) {
                switch (l.label) {
                    case 0:
                        return ba = null, (e = !1 === u.lean && ma > 0 && (ma < 1048576 || Sr.sequence > 0)) && T(1, 1), $n(),
                            function() {
                                var t = [];
                                ca = [];
                                for (var e = Sr.start + Sr.duration, n = Math.max(e - 2e3, 0), a = 0, r = ua; a < r.length; a++) {
                                    var i = r[a];
                                    i.time >= n && (i.time <= e && ca.push(i), t.push(i))
                                }
                                ua = t, oa(22)
                            }(), ot(), n = !0 === t, a = JSON.stringify(Tr(n)), r = "[".concat(fa.join(), "]"), i = e ? "[".concat(da.join(), "]") : "", o = function(t) {
                    ...
                    case 2:
                        s = l.sent(), l.label = 3;
                    case 3:
                        return _(2, (c = s) ? c.length : o.length), xa(o, c, Sr.sequence, n), fa = [], e && (da = [], ma = 0, ga = 0), [2]
                }
            }))
        }))
    }
    ...
    function Ma(t, e) {
        var n = ha[e];
        t && 4 === t.readyState && n && ((t.status < 200 || t.status > 208) && n.attempts <= 1 ? t.status >= 400 && t.status < 500 ? Qa(6) : (0 === t.status && (u.upload = u.fallback ? u.fallback : u.upload), xa(n.data, null, e)) : (va = {
            sequence: e,
            attempts: n.attempts,
            status: t.status
        }, n.attempts > 1 && Ga(2), 200 === t.status && t.responseText && function(t) {
        ...
        }(t.responseText), 0 === t.status && (xa(n.data, null, e, !0), Qa(3)), t.status >= 200 && t.status <= 208 && Sa(e), delete ha[e]))
    }
    ...
    function Ta(t) {
        var e = t.error || t;
        return e.message in _a || (_a[e.message] = 0), _a[e.message]++ >= 5 || e && e.message && (Na = {
            message: e.message,
            line: t.lineno,
            column: t.colno,
            stack: e.stack,
    ...
    function Da(t) {
        return Q(this, void 0, void 0, (function() {
            ...
            return $(this, (function(n) {
                switch (e = [l(), t], t) {
                    case 31:
                        e.push(Na.message), e.push(Na.line), e.push(Na.column), e.push(Na.stack), e.push(Na.source), ka(e);
                        break;
                    case 33:
                        Ia && (e.push(Ia.code), e.push(Ia.name), e.push(Ia.message), e.push(Ia.stack), e.push(Ia.severity), ka(e, !1));
                        break;
                    case 41:
                        pt && (e.push(pt.id), e.push(pt.target), e.push(pt.hash), ka(e, !1))
                }
                return [2]
            }))
        }))
    ...
    function ja(t, e, n, a, r) {
        ...
        t in Ca && Ca[t].indexOf(i) >= 0 || (Ia = {
            code: t,
            name: n,
            message: a,
            stack: r,
            severity: e
        }, t in Ca ? Ca[t].push(i) : Ca[t] = [i], Da(33))
    }
    var za, La = {},
        Aa = [],
        Ra = {},
    ...
    function qa() {
        try {
            for (var t in Ra) {
                var e = (r = Fa(Xa(Ra[t]))) ? JSON.stringify(r).substring(0, 1e4) : r;
                e && Ua(t, e)
            }
            for (var n in Ha) {
                var a = document.querySelector(Ha[n]);
                a && Ua(n, a.innerText)
            }
        } catch (t) {
            ja(5, 1, t ? t.name : null)
    ...
    function Ua(t, e, n) {
        void 0 === n && (n = !1), (!(t in La) || t in La && La[t] !== e || n) && (La[t] = e, Aa.push(t))
    }
    ...
    function Ga(t) {
        ...
        switch (t) {
            case 4:
                var n = h;
                n && ((e = [n.time, n.event]).push(n.data.visible), e.push(n.data.docWidth), e.push(n.data.docHeight), e.push(n.data.screenWidth), e.push(n.data.screenHeight), e.push(n.data.scrollX), e.push(n.data.scrollY), e.push(n.data.pointerX), e.push(n.data.pointerY), e.push(n.data.activityTime), ka(e, !1)), g();
                break;
            case 25:
                e.push(x.gap), ka(e);
                break;
    ...
    function Ka(t) {
        if (0 === za.check) {
            var e = za.check;
            e = Sr.sequence >= 128 ? 1 : e, e = l() > 72e5 ? 2 : e, (e = t > 10485760 ? 2 : e) !== za.check && Qa(e)
        }
    }
    ...
    function ir(t, e) {
        e && (e = "".concat(e), t in er || (er[t] = []), er[t].indexOf(e) < 0 && (er[t].push(e), t in nr || (nr[t] = []), nr[t].push(e), er[t].length > 128 && Qa(5)))
    }
    ...
    function dr() {
        ...
        var t = navigator && "userAgent" in navigator ? navigator.userAgent : "",
            ...
            n = function() {
                ...
                if (e) {
                    var n = e.split("|");
                    n.length >= 5 && t.ts - kr(n[1]) < 18e5 && (t.session = n[0], t.count = kr(n[2]) + 1, t.upgrade = kr(n[3]), t.upload = n.length >= 6 ? "".concat("https://").concat(n[5], "/").concat(n[4]) : "".concat("https://").concat(n[4]))
                }
                return t
            }(),
            a = Er();
        cr = {
            ...
            sessionId: n.session,
            pageNum: n.count
        }, u.lean = u.track && null !== n.upgrade ? 0 === n.upgrade : u.lean, u.upload = u.track && "string" == typeof u.upload && n.upload && n.upload.length > "https://".length ? n.upload : u.upload, ir(0, t), ir(3, e), ir(1, location.href), ir(2, document.referrer), ir(15, function() {
            var t = wr();
            ...
            return t
        }()), ir(16, document.documentElement.lang), ir(17, document.dir), navigator && (ir(9, navigator.userLanguage || navigator.language), navigator.userAgentData && navigator.userAgentData.getHighEntropyValues && navigator.userAgentData.getHighEntropyValues(["model", "platform", "platformVersion", "uaFullVersion"]).then((function(t) {
            var e;
            ir(22, t.platform), ir(23, t.platformVersion), null === (e = t.brands) || void 0 === e || e.forEach((function(t) {
                ir(24, t.name + "~" + t.version)
            })), ir(25, t.model), T(27, t.mobile ? 1 : 0)
    ...
    function hr(t, e) {
        void 0 === e && (e = !0), cr && !1 === e && t(cr, !u.lean), sr.push({
            callback: t,
            wait: e
        })
    }
    ...
    function mr() {
        var t = Math.round(Date.now()),
            ...
            n = u.lean ? 0 : 1;
        ! function(t) {
            sr.length > 0 && sr.forEach((function(e) {
                !e.callback || e.wait && !t || e.callback(cr, !u.lean)
            }))
        }(n), xr("_clsk", [cr.sessionId, t, cr.pageNum, n, e].join("|"), 1)
    }
    ...
    function yr(t, e) {
        ...
        (null === t.expiry || Math.abs(n - t.expiry) >= 1 || t.consent !== e) && xr("_clck", [cr.userId, 1, n.toString(36), e].join("|"), 365)
    }
    ...
    function Er() {
        ...
        if (e && e.length > 0) {
            ...
            n.length > 2 && (t.expiry = kr(n[2], 36)), n.length > 3 && 1 === kr(n[3]) && (t.consent = 1), u.track = u.track || 1 === t.consent, t.id = u.track ? n[0] : t.id
        }
        return t
    }
    ...
    function xr(t, e, n) {
        if (u.track && (navigator && navigator.cookieEnabled || br(document, "cookie"))) {
            var a = new Date;
            ...
            try {
                if (null === lr) {
                    for (var o = location.hostname ? location.hostname.split(".") : [], c = o.length - 1; c >= 0; c--)
                        if (lr = ".".concat(o[c]).concat(lr || ""), c < o.length - 1 && (document.cookie = "".concat(i).concat(";").concat("domain=").concat(lr), Or(t) === e)) return;
                    lr = ""
                }
            } catch (t) {
                lr = ""
            }
            document.cookie = lr ? "".concat(i).concat(";").concat("domain=").concat(lr) : i
        }
    }
    var Mr, Sr = null;
    ...
    function Tr(t) {
        return Sr.start = Sr.start + Sr.duration, Sr.duration = l() - Sr.start, Sr.sequence++, Sr.upload = t && "sendBeacon" in navigator ? 1 : 0, Sr.end = t ? 1 : 0, [Sr.version, Sr.sequence, Sr.start, Sr.duration, Sr.projectId, Sr.userId, Sr.sessionId, Sr.pageNum, Sr.upload, Sr.end]
    }
    ...
    function zr(t, e, n, a) {
        void 0 === a && (a = !1), n = Cr(n);
        try {
            t[c("addEventListener")](e, n, a), jr.push({
                event: e,
                target: t,
                listener: n,
                capture: a
    ...
    function Br() {
        Ur = !0, s = performance.now(), St(), Lr(), Dr(), Hr = Pr(), Yr = 0, zr(window, "popstate", Xr), null === Ar && (Ar = history.pushState, history.pushState = function() {
            Ar.apply(this, arguments), Fr() && Wr() && Xr()
        }), null === Rr && (Rr = history.replaceState, history.replaceState = function() {
    ...
    var Qr = Object.freeze({
        __proto__: null,
        start: function() {
            Xt(), qt(), aa(), Zn = null, Vn = new WeakMap, Fn = {}, Jn = [], Gn = !!window.IntersectionObserver, xn(),
                function() {
                    if (Fe = [], Qe = [], $e = null, tn = 0, en = {}, null === Ge && (Ge = CSSStyleSheet.prototype.insertRule, CSSStyleSheet.prototype.insertRule = function() {
                            return Fr() && un(this.ownerNode), Ge.apply(this, arguments)
                        }), null === Ze && (Ze = CSSStyleSheet.prototype.deleteRule, CSSStyleSheet.prototype.deleteRule = function() {
                            return Fr() && un(this.ownerNode), Ze.apply(this, arguments)
                        }), null === Ke) {
                        Ke = Element.prototype.attachShadow;
                        try {
                            Element.prototype.attachShadow = function() {
                                return Fr() ? un(Ke.apply(this, arguments)) : Ke.apply(this, arguments)
                            }
                        } catch (t) {
                            Ke = null
                        }
        ...
        stop: function() {
            aa(), Vn = null, Fn = {}, Jn = [], Zn && (Zn.disconnect(), Zn = null), Gn = !1, Mn(),
                function() {
        ...
        ti = {
            ...
            function(t) {
                Q(this, void 0, void 0, (function() {
                    var e, n;
                    return $(this, (function(a) {
                        return e = l(), n = [e, t], 29 === t && (n.push(ti.fetchStart), n.push(ti.connectStart), n.push(ti.connectEnd), n.push(ti.requestStart), n.push(ti.responseStart), n.push(ti.responseEnd), n.push(ti.domInteractive), n.push(ti.domComplete), n.push(ti.loadEventStart), n.push(ti.loadEventEnd), n.push(ti.redirectCount), n.push(ti.size), n.push(ti.type), n.push(ti.protocol), n.push(ti.encodedSize), n.push(ti.decodedSize), ei(), ka(n, !1)), [2]
                    }))
                }))
            }(29)
    }
    ...
    function ri() {
        try {
            ...
            for (var t = 0, e = ai; t < e.length; t++) {
                var n = e[t];
                PerformanceObserver.supportedEntryTypes.indexOf(n) >= 0 && ("layout-shift" === n && _(9, 0), $r.observe({
                    type: n,
                    buffered: !0
                }))
            }
        ...
        ! function(t) {
            for (var e = (!("visibilityState" in document) || "visible" === document.visibilityState), n = 0; n < t.length; n++) {
                ...
                switch (a.entryType) {
                    ...
                    case "resource":
                        var r = a.name;
                        ir(4, oi(r)), r !== u.upload && r !== u.fallback || T(28, a.duration);
                        break;
                    case "longtask":
                        N(7);
                        break;
    ...
    var ui = [Zr, Qr, Ae, Object.freeze({
        __proto__: null,
        start: function() {
            ei(),
                function() {
                    window.PerformanceObserver && PerformanceObserver.supportedEntryTypes ? "complete" !== document.readyState ? zr(window, "load", D.bind(this, ri, 0)) : ri() : ja(3, 0)
                }()
        },
        stop: function() {
    ...
    function ci(t) {
        void 0 === t && (t = null),
            function() {
                try {
                    return !1 === Ur && "undefined" != typeof Promise && window.MutationObserver && document.createTreeWalker && "now" in Date && "now" in performance && "undefined" != typeof WeakMap
                } catch (t) {
                    return !1
                }
            }() && (Jr(t), Br(), rt(), ui.forEach((function(t) {
                return Cr(t.start)()
            })))
    }

    function si() {
        Fr() && (ui.slice().reverse().forEach((function(t) {
            return Cr(t.stop)()
        })), it(), Vr())
    }
    var li = Object.freeze({
        ...
        start: ci,
        pause: function() {
            Fr() && (O("clarity", "pause"), null === xt && (xt = new Promise((function(t) {
                Mt = t
            }))))
        },
        resume: function() {
            Fr() && (xt && (Mt(), xt = null, null === Ot && _t()), O("clarity", "resume"))
        },
        stop: si,
        consent: vr,
        event: O,
